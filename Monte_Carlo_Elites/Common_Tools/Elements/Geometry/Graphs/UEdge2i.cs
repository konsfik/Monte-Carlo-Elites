...
{
    public struct UEdge2i : IEquatable<UEdge2i>
    {
        public readonly Vec2i origin;
        public readonly Vec2i exit;

        public UEdge2i(Vec2i origin, Vec2i exit)
        {
            this.origin = origin;
            this.exit = exit;
        }
        ...
        public bool Equals(UEdge2i other)
        {
            return
            (
        ...
        {
            if (otherObject is UEdge2i other_edge)
            {
        ...
        public static bool operator ==(UEdge2i c1, UEdge2i c2)
        {
