...
{
    public class MEL_PSM__UCB_Offspring_Survival__Per__Location<T> : MEL__Parent_Selection_Method__UCB<T>
        where T:MEL__Individual
    {
        public MEL_PSM__UCB_Offspring_Survival__Per__Location(double c_value):base(c_value)
        {
